...
| Command | Description |
| --- | --- |
| `sudo pacman -S docker` | Install Docker (Arch Linux). |
| `sudo apt install docker.io` | Install Docker (Debian/Ubuntu/Pop!_OS). |
| `sudo dnf install docker` | Install Docker (Fedora/RHEL). |
